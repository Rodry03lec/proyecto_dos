 ...
 *   https://datatables.net/download/#bs5/dt-2.1.8/af-2.7.0/b-3.1.2/b-colvis-3.1.2/b-html5-3.1.2/fc-5.0.3/sc-2.4.3/sb-1.8.1/sl-2.1.0
 *
 * Included libraries:
 *  DataTables 2.1.8, AutoFill 2.7.0, Buttons 3.1.2, Column visibility 3.1.2, HTML5 export 3.1.2, FixedColumns 5.0.3, Scroller 2.4.3, SearchBuilder 1.8.1, Select 2.1.0
 */
...
!(function (n) {
            ...
            ((V.ext = C =
                {
                    ...
                    classes: {},
                    builder:
                        "bs5/dt-2.1.8/af-2.7.0/b-3.1.2/b-colvis-3.1.2/b-html5-3.1.2/fc-5.0.3/sc-2.4.3/sb-1.8.1/sl-2.1.0",
                    errMode: "alert",
                    feature: [],
                    features: {},
                    search: [],
    ...
    function re(t, e, n) {
        ...
        return e
            ...
            .replace(/_ENTRIES_/g, t.api.i18n("", "", n))
            .replace(/_ENTRIES-MAX_/g, t.api.i18n("", "", l))
            .replace(/_ENTRIES-TOTAL_/g, t.api.i18n("", "", i));
    }
    var oe = [],
        n = Array.prototype;
    (X = function (t, e) {
    ...
    var p = f.fn.dataTable,
        ...
        t =
            (f.extend(d.prototype, {
                ...
                disable: function () {
                    return (
                        (this.s.enabled = !1), this._focusListenerRemove(), this
                    );
                },
                    ...
                    "focus" === o
                        ...
                        ? (f(e.table().body()).on(
                          ...
                          f(m.body).on("click" + t, function (t) {
                              f(t.target).parents().filter(e.table().body())
                                  .length || i._detach();
                          }))
                        : f(e.table().body())
                              .on(
...
!(function (e) {
    ...
    x.extend(_.prototype, {
            ...
            if (void 0 !== n) {
                ...
                for (
                    ...
                    this._expandButton(
                        ...
                        void 0 !== i &&
                            void 0 !== i.config &&
                            void 0 !== i.config.split,
                        !0,
                        void 0 !== i.parentConf &&
                            void 0 !== i.parentConf.split,
                        null,
                        i.parentConf
                    );
                }
        ...
        node: function (t) {
            return t
                ? ((t = this._nodeToButton(t)), x(t.node))
                : this.dom.container;
        },
        ...
        remove: function (t) {
            ...
            (n.conf.destroying = !0),
                n.conf.destroy &&
                    n.conf.destroy.call(o.button(t), o, x(t), n.conf),
        ...
        _addKey: function (t) {
            t.key &&
                (this.s.listenKeys += (x.isPlainObject(t.key) ? t.key : t).key);
        },
        _draw: function (t, n) {
        ...
        _expandButton: function (t, n, e, o, i, s, r) {
            for (
                var a,
                    ...
                    d = 0,
                    f = (u = void 0 === n ? (Array.isArray(e) ? e : [e]) : u)
                        .length;
                d < f;
                d++
            ) {
                ...
                if (p)
                    if (
                        ((a = !(!p.config || !p.config.split)),
                        Array.isArray(p))
                    )
                        this._expandButton(
                            t,
                            p,
                            void 0 !== h && void 0 !== h.conf
                                ? h.conf.split
                                : void 0,
                            o,
                ...
                p = x.extend(
                    {
                        ...
                        closeButton: !0,
                        containerClassName:
                            d.dom.collection.container.className,
                        contentClassName:
                            d.dom.collection.container.content.className,
                        collectionLayout: "",
                        collectionTitle: "",
                        dropup: !1,
                        fade: 400,
                ...
                : ((d = x(
                  ...
                  "absolute" === d
                      ? ((t = x(b[0].offsetParent)),
                        ...
                        d.left + a < 0 && (a = -d.left),
                        s.top + t + l.height >
                            x(g).height() + x(g).scrollTop() &&
                            (t =
                                n.top -
                                l.height -
                                l.marginTop -
                                l.marginBottom),
                        s.top + t < x(g).scrollTop() &&
                            (t = n.top + b.outerHeight()),
                        e.css({ top: t, left: a }))
                      : ((c = function () {
                            var t = x(g).height() / 2,
        ...
        e.Api.register("buttons()", function (n, e) {
            ...
            var t = this.iterator(
                ...
                function (t) {
                    if (t._buttons)
                        return _.buttonSelector(
                            _.instanceSelector(n, t._buttons),
                            e
                        );
                },
                !0
        ...
        e.Api.register("buttons().containers()", function () {
            ...
            return (
                this.iterator(!0, "table", function (t) {
                    if (t._buttons)
                        for (
                            var n = _.instanceSelector(s, t._buttons),
                                e = 0,
                                o = n.length;
                            e < o;
                            e++
        ...
        e.Api.register("button().add()", function (t, n, e) {
            ...
            return (
                o.length &&
                    (o = _.instanceSelector(this._groupSelector, o[0]._buttons))
                        .length &&
                    o[0].add(n, t, e),
                ...
                var s = x.extend(
                    ...
                    o =
                        (i.select &&
                            ...
                            void 0 === e.selected &&
                            i
                                .rows(s.rows, x.extend({ selected: !0 }, e))
                                .any() &&
        ...
        ? ((o = require("jquery")),
          (e = function (n, t) {
              t.fn.dataTable || require("datatables.net")(n, t),
                  t.fn.dataTable.Buttons ||
                      require("datatables.net-buttons")(n, t);
          }),
          "undefined" == typeof window
              ...
              : (e(window, o),
                (module.exports = i(o, window, window.document))))
            ...
            columnVisibility: {
                ...
                init: function (i, n, o) {
                    ...
                    n.attr("data-cv-idx", o.columns),
                        i
                            .on(
                                "column-visibility.dt" + o.namespace,
                                function (n, t) {
                                    t.bDestroying ||
            ...
            colvisRestore: {
                ...
                init: function (n, t, i) {
                    n.columns().every(function () {
                        var n = this.init();
                        void 0 === n.__visOriginal &&
                            (n.__visOriginal = this.visible());
                    });
                },
                action: function (n, t, i, o) {
    ...
    "function" == typeof define && define.amd
        ...
        ? ((l = require("jquery")),
          ...
          "undefined" == typeof window
              ...
              : (n(window, l),
                (module.exports = o(l, window, window.document))))
        : o(jQuery, window, document);
})(function (S, C, u) {
    "use strict";
    var e,
        ...
        (t.ext.buttons.excelHtml5 = {
            ...
            action: function (t, e, o, f, l) {
                ...
                I.title &&
                    ...
                    I.messageTop &&
                        (r([I.messageTop]), D(c, u, 0, 1, i.header.length)),
                    f.header && a(i.headerStructure);
                for (var F = u, x = 0, h = i.body.length; x < h; x++)
                    r(i.body[x]);
                (d = u),
    ...
    function d(t, e) {
        ...
        if (l && l.versionCheck && l.versionCheck("2"))
            return (
                ...
                (this.dom = {
                    bottomBlocker: h("<div>").addClass(
                        this.classes.bottomBlocker
                    ),
        ...
        (d.prototype._scroll = function () {
            ...
            o &&
                ((t = h(this.s.dt.table().node())
                    ...
                    .add(
                        "div.dt-scroll-headInner table",
                        this.s.dt.table().container()
                    )
                    .add(
                        "div.dt-scroll-footInner table",
                        this.s.dt.table().container()
                    )),
                (e = o.scrollLeft),
                (s = !this.s.rtl),
        ...
        (d.prototype._setKeyTableListener = function () {
            ...
            this.s.dt.on("key-focus.dt.dtfc", function (t, e, s) {
                var i,
                    ...
                    d = c.dom.scroller[0],
                    r = h(
                        h(c.s.dt.table().node()).closest("div.dt-scroll-body")
                    );
                0 < c.c.start &&
                    ((l = (o = h(
                        c.s.dt.column(c.c.start - 1).header()
                    )).offset()),
                    (o = o.outerWidth()),
                    h(s.node()).hasClass(c.classes.fixedLeft)
                        ...
                        : n.left < l.left + o &&
                          ((i = r.scrollLeft()),
                          r.scrollLeft(i - (l.left + o - n.left)))),
                    0 < c.c.end &&
...
!(function (t) {
    ...
    "function" == typeof define && define.amd
        ? define(
              ["jquery", "datatables.net-bs5", "datatables.net-fixedcolumns"],
              function (e) {
            ...
            (d.extend(i.prototype, {
                    ...
                    var s = this.s.heights,
                        o =
                            (s.row &&
                                ...
                                (this.s.viewportRows =
                                    parseInt(s.viewport / s.row, 10) + 1),
                    ...
                    t.on("stateSaveParams.scroller", function (t, s, o) {
                        i && r
                            ? ((o.scroller = r.scroller),
                              (i = !1),
                              o.scroller &&
                                  (e.s.lastScrollTop = o.scroller.scrollTop))
                            : (o.scroller = {
                        ...
                        t.on("stateLoadParams.scroller", function (t, s, o) {
                            void 0 !== o.scroller &&
                                e.scrollToRow(o.scroller.topRow);
                        }),
                        this.measure(!1),
                        r &&
                            r.scroller &&
                            ...
                            (this.s.baseScrollTop =
                                this.s.baseRowTop * this.s.heights.row),
                ...
                _calcRowHeight: function () {
                    var t = this.s.dt,
                        ...
                        r =
                            (d("tbody tr:lt(4)", s).clone().appendTo(e),
                            d("tr", e).length);
                    if (1 === r)
                ...
                _info: function () {
                    if (this.s.dt.oFeatures.bInfo) {
                            ...
                            l =
                                (r =
                                    "jump" === this.s.scrollType
                                        ...
                                        : r) +
                                Math.floor(
                                    this.s.heights.viewport / this.s.heights.row
                                ),
                            l = i < l ? i : l,
                            a =
                                0 === i && i == e
                                    ...
                                    : o.sInfo +
                                      ...
                                      o.sInfoPostFix,
                            o =
                                ((a = this._macros(a, r, l, e, i)),
                                o.fnInfoCallback),
                            n =
                                (o &&
                                    (a = o.call(t.oInstance, t, r, l, e, i, a)),
                                t.aanFeatures.i);
                        if (void 0 !== n) {
                        ...
                        d("div.dt-info", s.table().container()).each(
                            function () {
                                d(this).html(a),
                                    s.trigger("info", [
                                        s.settings()[0],
                    ...
                    return (
                        (null !== t &&
                            ...
                            "px" === (t = t[2])
                                ...
                                ? (s =
                                      o *
                                      parseFloat(d(":root").css("font-size")))
                                : "em" === t &&
                                  (s =
                                      o *
                                      parseFloat(d("body").css("font-size"))),
                            s)) ||
                        0
                    );
                },
    ...
    return (
            ...
            if (
                ...
                void 0 !== t.data &&
                    ...
                    this.dom.data.children("option").each(function () {
                        ...
                        (w(this).text() === t.data ||
                            (t.origData &&
                                w(this).prop("origData") === t.origData))
                ...
                for (
                    var o = void 0,
                        r = this.dom.condition.children("option"),
                        a = 0;
                    a < r.length;
                    a++
                ) {
                ...
                if (((this.s.condition = o), void 0 !== this.s.condition)) {
                    for (
                        ...
                        var l = w(r[a]);
                        l.val() !== this.s.condition &&
                            l.removeProp("selected");
                    }
            ...
            if (0 === i) {
                (this.s.type = e.column(s).type()),
                    ...
                    (null !== this.s.type && void 0 !== this.s.type) ||
                        (w.fn.dataTable.ext.oApi &&
                            w.fn.dataTable.ext.oApi._fnColumnTypes(
                                e.settings()[0]
                            ),
                        (this.s.type = e.column(s).type())),
                    this.dom.condition
                ...
                var o = e.settings()[0].oLanguage.sDecimal,
                    r =
                        ("" !== o &&
                            this.s.type &&
                            this.s.type.indexOf(o) ===
                                this.s.type.length - o.length &&
                ...
                void 0 !== this.c.conditions[this.s.type]
                    ...
                    ? ((r = B.use("moment")
                      ...
                      (this.s.dateFormat = this.s.type.replace(
                          /datetime-/g,
                          ""
                      )))
                ...
                this.dom.condition
                    ...
                    .addClass(this.classes.italic);
                for (
                    var c = 0, h = Object.keys(this.s.conditions);
                    c < h.length;
                    c++
                ) {
                    d = h[c];
                ...
                if ("number" == typeof v)
                    ...
                    for (var b = 0; b < t.length; b++)
                        for (
                            ...
                            if (
                                ("string" ==
                                typeof (V = this.s.conditions[I].conditionName)
                                    ? V
                ...
                var s = e.dom.data.children("option:selected").val(),
                    ...
                    a =
                        ...
                        w("<select/>")
                            ...
                            .on("change.dtsb", function () {
                                w(this).removeClass(D.classes.italic),
                                    t(e, this);
                            })),
        ...
        (D.inputValueSelect = function (t) {
            for (var i = [], e = 0, n = t; e < n.length; e++) {
                ...
                s.is("select") &&
                    i.push(
                        D._escapeHTML(s.children("option:selected").data("sbv"))
                    );
            }
            return i;
        }),
        (D.inputValueInput = function (t) {
            ...
            return i.map(c.util.diacritics);
        }),
            ...
            if (
                ...
                (void 0 === i || i.includes(void 0) || i.includes(null)) &&
                    (l.fn.dataTable.ext.oApi &&
                        l.fn.dataTable.ext.oApi._fnColumnTypes(
        ...
        (B.ext.buttons.searchBuilder = {
            ...
            init: function (i, t, e) {
                var n = this,
                    s = new B.SearchBuilder(i, e.config);
                i.on("draw", function () {
                    ...
                    n.text(
                        e.text ||
                            i.i18n("searchBuilder.button", s.c.i18n.button, 0)
                    ),
                    (e._searchBuilder = s);
            },
            text: null,
...
!(function (l) {
    ...
    function c(e) {
        ...
        m(e.table().container())
            ...
            m("body").off("click.dtSelect" + _(e.table().node()));
    }
    function n(o) {
        var a,
                ...
                m(e.target).closest("div.dt-container")[0] == n &&
                    ...
                    c.isDefaultPrevented() ||
                        ...
                        "row" === l
                            ...
                            : "cell" === l &&
                              ((t = n.index()), h(e, o, s, "cell", t)),
                        (s._select_lastCell = c)));
            }),
            m("body").on("click.dtSelect" + _(o.table().node()), function (e) {
                var t;
                !l._select.blurable ||
    ...
    function s(s, e) {
        ...
        "api" !== s.select.style() &&
            !1 !== s.select.info() &&
            ((o =
                s.settings()[0]._select_set.length ||
                s.rows({ selected: !0 }).count()),
            (t = s.columns({ selected: !0 }).count()),
            (l = s.cells({ selected: !0 }).count()),
            (c = function (e, t, l) {
                e.append(
    ...
    function o(o) {
        ...
        (o._select_init = !0),
            ...
            o.aoRowCreatedCallback.push(function (e, t, l) {
                ...
                for (
                    (n._select_selected ||
                        ("undefined" !== l && o._select_set.includes(l))) &&
            ...
            (r = a).on("select", function (e, t, l, s) {
                if ("row" === l)
                    for (
                        var l = r.settings()[0],
                            c = r,
                        ...
                        var i = c.row(o[a]).id();
                        i && "undefined" !== i && !n.includes(i) && n.push(i);
                    }
            }),
            r.on("deselect", function (e, t, l, s) {
                if ("row" === l)
                    for (
                        var l = r.settings()[0],
                            c = r,
            ...
            a.on("destroy.dtSelect", function () {
                m(a.rows({ selected: !0 }).nodes()).removeClass(
                    a.settings()[0]._select.className
                ),
                    m("input." + v(!0), a.table().header()).remove(),
                    c(a),
                    a.off(".dtSelect"),
                    m("body").off(".dtSelect" + _(a.table().node()));
            });
    }
    function d(e, t, l, s) {
        var c,
    ...
    (p.select = {}),
        ...
        (p.select.version = "2.1.0"),
        (p.select.init = function (o) {
            var e,
                t,
                l,
                s,
            ...
            !_._select &&
                ...
                (t = function (e, t, l) {
                    if (null !== l && void 0 !== l.select) {
                        if (
                            (o.rows({ selected: !0 }).any() &&
                                o.rows().deselect(),
                            void 0 !== l.select.rows &&
                                o.rows(l.select.rows).select(),
                            o.columns({ selected: !0 }).any() &&
                                o.columns().deselect(),
                            void 0 !== l.select.columns &&
                                o.columns(l.select.columns).select(),
                            o.cells({ selected: !0 }).any() &&
                                o.cells().deselect(),
                    ...
                    .on("stateSaveParams", function (e, t, l) {
                        (l.select = {}),
                            (l.select.rows = o
                                ...
                                .ids(!0)
                                .toArray()),
                            (l.select.columns = o.columns({ selected: !0 })[0]),
                            (l.select.cells = o
                                .cells({ selected: !0 })[0]
                                .map(function (e) {
                                    return {
                                        row: o.row(e.row).id(!0),
                                        column: e.column,
                                    };
                                }));
                    })
                ...
                o.select.style(c),
                o.select.blurable(n),
                o.select.toggleable(a),
                o.select.info(r),
                o.select.selectable(i),
                (_._select.className = d),
                !h &&
                    m(o.table().node()).hasClass("selectable") &&
                    o.select.style("os"),
                f || "select-page" === f || "select-all" === f) &&
                o.ready(function () {
                    var c, n, l;
                    (n = f),
                        (l = (c = o).settings()[0].aoColumns),
    ...
    t("select()", function () {
        ...
        t("select.selectable()", function (e) {
            var t = this.context[0];
            return e
                ? ((t._select.selectable = e), this)
                : t._select.selectable;
        }),
    ...
    return (
        m.extend(p.ext.buttons, {
            ...
            showSelected: {
                text: a("showSelected", "Show only selected"),
        ...
        m.extend(!0, p.defaults.oLanguage, {
            select: { aria: { rowCheckbox: "Select row" } },
        }),
        (p.render.select = function (e, t) {
            function l(e, t, l, s) {
                var c = s.settings.aoData[s.row],
                    n = c._select_selected,
                    o = s.settings.oLanguage.select.aria.rowCheckbox,
                    a = s.settings._select.selectable;
                return "display" !== t
                    ? "type" === t
                        ? "select-checkbox"
                        : "filter" !== t && n
            ...
            var i = e ? p.util.get(e) : null,
                r = t ? p.util.get(t) : null;
            return (l._name = "selectCheckbox"), l;
        }),
